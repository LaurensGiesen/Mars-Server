...
class ShopTest {
    ...
    ERROR  Address u1Address = new Address("Marsstraat", 2, "Dome 1");
    ...
    ERROR User u2 = new User(2, "Piet", "DeLange", "piet.delange@student.howest.be", u2Date, u2Subscription, u2Address, new Favorite(1));
